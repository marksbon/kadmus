                ...
                <div class="box-body">
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      ...
                      <li><a href="#tab_5" data-toggle="tab">All Approved</a></li>
                      <li><a href="#tab_5" data-toggle="tab">Approved Request</a></li>
                      <li><a href="#suppliers" data-toggle="tab">Approved Qoutes</a></li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="allsup" style="overflow: hidden;">
                            <div class="col-md-4">
                              ...
                              <form >
                               ...
                               <button class="btn btn-block btn-success btn-sm" data-toggle="modal" data-target="#compose-modal">Generate Ledger sheet</button>
                              </form>
                            </div>
                            <div class="col-md-4">
                              <label>Quotes</label>
