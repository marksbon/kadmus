                ...
                <div class="box-body">
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="#inventory" data-toggle="tab">Payslip Population</a></li>
                      <li><a href="#new" data-toggle="tab">Staff Salaries</a></li>
                      <li><a href="#tab_5" data-toggle="tab">Agents Salaris</a></li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="allsup" style="overflow: hidden;">
                            <form class="form-horizontal">
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="department" data-placeholder="Select Category" required style="100px">
                                 <option></option>
