      ...
      <!--------- End of logic -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              ?>
                <li><a href="<?php print base_url().$General[$i]['link']; ?>"><i class="fa <?php print $General[$i]['icon']; ?>"></i> <?php print $General[$i]['name']; ?></a></li>
              <?php
                        }
                    }
              ?>
            ...
            <li class="treeview">
              ...
              ?>
                <li><a href="<?php print base_url().$Site[$i]['link']; ?>"><i class="fa <?php print $Site[$i]['icon']; ?>"></i> <?php print $Site[$i]['name']; ?></a></li>
              <?php
                        }
                    }
              ?>
            ...
            <li class="treeview">
              ...
              ?>
                <li><a href="<?php print base_url().$Procurement[$i]['link']; ?>"><i class="fa <?php print $Procurement[$i]['icon']; ?>"></i> <?php print $Procurement[$i]['name']; ?></a></li>
              <?php
                        }
                    }
              ?>
            ...
            <li class="treeview">
              ...
              ?>
                <li><a href="<?php print base_url().$Stores[$i]['link']; ?>"><i class="fa <?php print $Stores[$i]['icon']; ?>"></i> <?php print $Stores[$i]['name']; ?></a></li>
              <?php
                        }
                    }
              ?>
            ...
            <li class="treeview">
              ...
              ?>
                <li><a href="<?php print base_url().$Accounts[$i]['link']; ?>"><i class="fa <?php print $Accounts[$i]['icon']; ?>"></i> <?php print $Accounts[$i]['name']; ?></a></li>
              <?php
                        }
                    }
              ?>
            ...
            <li class="treeview">
              ...
              ?>
                <li><a href="<?php print base_url().$Human_Resource[$i]['link']; ?>"><i class="fa <?php print $Human_Resource[$i]['icon']; ?>"></i> <?php print $Human_Resource[$i]['name']; ?></a></li>
              <?php
                        }
                    }
              ?>
            ...
            <li class="treeview">
              ...
              ?>
                <li><a href="<?php print base_url().$Administration[$i]['link']; ?>"><i class="fa <?php print $Administration[$i]['icon']; ?>"></i> <?php print $Administration[$i]['name']; ?></a></li>
              <?php
                        }
                    }
              ?>
