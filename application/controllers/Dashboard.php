...
class Dashboard extends CI_Controller {
	...
	************************************************/
	public function index() 
	{
		...
		{
			#Checking if Session is Freezed
      if(isset($_SESSION['login_state']) && $_SESSION['login_state'] == "Freezed")
      ...
      else
      {
        ...
        /************************ User Roles & Priviledges ********************
          $roles_priv = $this->Model_Access->roles_priviledges_user('access_roles_priviledges_user',$_SESSION['employee_id']);
          ...
          if(!empty($roles_priv)) 
          {
            ...
            if(!empty($group_id))
            {
              ...
              if(!empty($roles_priv_retrieve))
              {
                ...
                $data['session_array']['rows_exploded'] = explode("|", $temp_array['rows_unexploded']);
                $data['session_array']['priv_exploded'] = explode("|", $temp_array['priv_unexploded']);
              }
            }
        ...
        {
        	$headertag['title'] = "Dashboard";
        	$this->load->view('reserved/dashboard');
        	$this->load->view('footer');
        }
      }
		} 
